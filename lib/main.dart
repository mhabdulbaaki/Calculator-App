                  ...
                  children: [
                    TableRow(
                      children: [
                        ...
                        appButton('+/-', Colors.black),
                      ],
                    ),
                    TableRow(
                      children: [
                        appButton('7', Colors.black),
                        appButton('8', Colors.black),
                        appButton('9', Colors.black),
                      ],
                    ),
                    TableRow(children: [
                      appButton('4', Colors.black),
                      appButton('5', Colors.black),
                      appButton('6', Colors.black),
                    ]),
                    TableRow(children: [
                      appButton('1', Colors.black),
                      appButton('2', Colors.black),
                      appButton('3', Colors.black),
                    ]),
                    TableRow(children: [
                      appButton('0', Colors.black),
                      appButton('.', Colors.black),
                      appButton('00', Colors.black),
                    ]),
                  ],
                ),
              ),
